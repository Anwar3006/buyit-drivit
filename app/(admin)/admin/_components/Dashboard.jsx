  ...
  if (!initialData || !initialData.success) {
    return (
      <Alert variant="destructive">
        <AlertCircleIcon />
        <AlertTitle>Unable to retrieve data.</AlertTitle>
        <AlertDescription>
          <p>{initialData?.error || "Failed to load dashboard data"}</p>
        </AlertDescription>
      </Alert>
    );
  }
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl text-bold">{cars.total}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl text-bold">{testDrives.total}</div>
                <p className="text-xs text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl text-bold">{cars.sold}</div>
                <p className="text-xs text-muted-foreground">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="p-4 rounded-lg bg-gray-50">
                    ...
                    <div className="flex items-center">
                      <div className="h-2.5 w-full bg-gray-200 rounded-full">
                        <div
                          className="bg-sky-500 rounded-full h-2.5"
                          style={{
                            width: `${
