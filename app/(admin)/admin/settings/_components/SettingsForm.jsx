                  ...
                  >
                    ...
                    <div className="col-span-9 md:col-span-2 flex items-center">
                      ...
                      <Label
                        ...
                        className="ml-2 cursor-pointer text-xs md:text-base"
                      >
        ...
        <TabsContent value="admins">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage users with admin priviledges
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="mb-6 relative">
                <SearchIcon className="absolute left-2.5 top-2.5 h-4 w-4 stroke-gray-500" />
                <Input
